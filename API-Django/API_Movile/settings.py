"""
Django settings for API_Movile project.
...
SECRET_KEY = 'django-insecure-4-b)+se=i8+hnpn%1=cgpt+2-y4$2#o#0x1r4bj#=3li4+q3cj'
...
WSGI_APPLICATION = 'API_Movile.wsgi.application'
